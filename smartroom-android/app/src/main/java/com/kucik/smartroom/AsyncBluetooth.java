...
public class AsyncBluetooth {
    ...
    String saklar_channel = "http://smartroom.com/6fb658cc-05fe-11e6-8001-005056805279/";
    ...
    public void getDataSuhu(){
        ...
        httpClient.setTimeout(30);
        String api_url = "http://smartroom.com/c68a9cbe-15d3-11e6-8001-005056805279/channel/last/feed/275/12";
    ...
    public void getDataPDAM(){
        ...
        httpClient.setTimeout(30);
        String api_url = "http://smartroom.com/96b322c6-15d4-11e6-8001-005056805279/channel/last/feed/278/100";
    ...
    public void getDataListrik(){
        String api_url = "http://smartroom.com/f9de5cb8-15d3-11e6-8001-005056805279/channel/last/feed/276/1";
        httpClient.get(context,api_url,new JsonHttpResponseHandler(){
            @Override
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                //super.onSuccess(statusCode, headers, response);
    ...
    public void getDataLPG(){
        String api_url = "http://smartroom.com/82f8f396-15d4-11e6-8001-005056805279/channel/last/feed/277/1";
        httpClient.get(context,api_url,new JsonHttpResponseHandler(){
            @Override
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                //super.onSuccess(statusCode, headers, response);
